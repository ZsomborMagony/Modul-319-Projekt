...
public class Story {
    public static void intro() {
        ...
        System.out.println("Player:\n" +
                "YOU ARE DOING ALL THIS JUST FOR MONEY AND POWER?! You are selling the country out, letting people suffer, making everything overpriced so you can get enough money?\n");
        System.out.println("King: \n" +
        ...
        System.out.println("(The black orb lights up and you feal a strange sensation and realize that you are losing your strength)");
        System.out.println("Player: \n" +
        ...
        System.out.println("Player: Yeah! I managed to recover thanks to your quick actions, but I feel like I am missing something.");
        System.out.println("Barbarian Companion: How should I explain it to you? Dou you remember the black orb that the bastard king was holding?");
        System.out.println("Player: Yeah.\n" +
                "Barbarian Companion: That thing took away most of your powers somehow. Luckily we were fast enough to intercept it before it took everything away though I don’t know what power you have remaining.\n");
        System.out.println("Cleric Companion: Considering the situation at hand, I advise you to retire for the time being and enjoy life as much as possible");
        System.out.println("Mage Companion(traitor): We understand that it is hard for you to accept it but right now you are nothing else but an ordinary human.");
        System.out.println("Player: I am happy to hear that you guys are so concerned about me, but I can’t give up now that I saw how the king treats his own people and letting them suffer. I must become strong again to be able to stand against the king.");
        System.out.println("Barbarian Companion: We thought you would say and we also have an idea on how to make you stronger again, but first of all we are going to check how much power you have left.");
        System.out.println("(After this short discussion, Your team with you approval conducted several small experiences to see how much power you have remaining)");
        System.out.println("Cleric Companion: It seems like you still have your ability to use any weapon after you touch them(Weapon Mastery) and also magic.");
        ...
        System.out.println("(You dress up, take a sword and go to the first dungeon)");
