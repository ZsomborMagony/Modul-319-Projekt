...
public class Armor {
    ...
    public static Armor padded = new Armor("Padded", 500, 11
            + Player.PlayerStats.statModifiers("dexterity"), 0, false, 8);
    public static Armor leather = new Armor("Leather", 1000, 11
            + Player.PlayerStats.statModifiers("dexterity"), 0, true, 10);
    public static Armor studdedLeather = new Armor("Studded Leather", 4500, 12
            + Player.PlayerStats.statModifiers("dexterity"), 0, true, 13);

    // Medium Armor
    public static Armor hide = new Armor("Hide", 1000, 12
            + Player.PlayerStats.statModifiers("dexterity"), 0, true, 12);
    public static Armor chainShirt = new Armor("Chain Shirt", 5000, 13
            + Player.PlayerStats.statModifiers("dexterity"), 0, true, 20);
    public static Armor scaleMail = new Armor("Scale Mail", 5000, 14
            + Player.PlayerStats.statModifiers("dexterity"), 0, false, 45);
    ...
    public static Armor halfPlate = new Armor("Half Plate", 75000, 15
            + Player.PlayerStats.statModifiers("dexterity"), 0, false, 40);
